...
To keep the coding style uniform, please follow the following style rules:
  ...
  - Generally use snake_case, not CamelCase
    + CamelCase is acceptable for classes,
    + but snake_case should always be used for function names and variables
...
-----
<sub>These contributing guidelines are adapted from guidelines used in other repositories by [duckmayr](https://github.com/duckmayr) such as [`gpirt`](https://github.com/duckmayr/gpirt)
